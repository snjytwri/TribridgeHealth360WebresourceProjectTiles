...
Tribridge.CRMSDK.METADATA.Tiles = {};
 ...
 */
Tribridge.CRMSDK.METADATA.Tiles.RetrieveAttribute = function (entityName, attributeName, metadataId, asIfPublished, successCallBack, errorCallBack, passthrough)
{
   var entityLogicalNameValueNode;

   if (Tribridge.CRMSDK.METADATA.Tiles.IsNullOrEmpty(entityName))
   ...
   if (Tribridge.CRMSDK.METADATA.Tiles.IsNullOrEmpty(attributeName))
   ...
   if (Tribridge.CRMSDK.METADATA.Tiles.IsNullOrEmpty(metadataId))
   ...
   req.open("POST", Tribridge.CRMSDK.METADATA.Tiles.GetServerUrl(), (successCallBack != null));
      ...
      req.onreadystatechange = function ()
      {
         if (req.readyState == 4)
         {
            ...
            if (req.status == 200)
            {
               ...
               successCallBack(Tribridge.CRMSDK.METADATA.Tiles.SoapParseAttributeResponse(docXml), passthrough);
            }
            else
            {
               if (!Tribridge.CRMSDK.METADATA.Tiles.IsNullOrEmpty(errorCallBack))
   ...
   else
   {
      ...
      var docText = req.responseText;
      var docXml = req.responseXML;
      return Tribridge.CRMSDK.METADATA.Tiles.SoapParseAttributeResponse(docXml);
   }
};

Tribridge.CRMSDK.METADATA.Tiles.RetrieveEntity = function (entityName, entityFilter, metadataId, asIfPublished, successCallBack, errorCallBack, passthrough)
{
      ...
      req.onreadystatechange = function ()
      {
         if (req.readyState == 4)
         {
            ...
            if (req.status == 200)
            {
               ...
               switch (entityFilter)
               {
                  case Tribridge.CRMSDK.METADATA.Tiles.EntityFilters.Attributes:
                     successCallBack(Tribridge.CRMSDK.METADATA.Tiles.SoapParseEntityAttributeResponse(docXml), passthrough);
                     break;
                  default:
                     successCallBack(Tribridge.CRMSDK.METADATA.Tiles.SoapParseEntityAttributeResponse(docXml), passthrough);
                     break;
...
Tribridge.CRMSDK.METADATA.Tiles.SoapParseEntityAttributeResponse = function (responseXML)
{
   var rootNode = responseXML.getElementsByTagName('a:Results');
   var schemaname = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(rootNode[0].getElementsByTagName('c:SchemaName')[0]);
   var objectcode = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(rootNode[0].getElementsByTagName('c:ObjectTypeCode')[0]);
   var logical = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(rootNode[0].getElementsByTagName('c:LogicalName')[0]);

   var primaryIdAttribute = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(rootNode[0].getElementsByTagName('c:PrimaryIdAttribute')[0]);
   var primaryNameAttribute = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(rootNode[0].getElementsByTagName('c:PrimaryNameAttribute')[0]);

   var retCollection = [];
   if (!Tribridge.CRMSDK.METADATA.Tiles.IsNullOrEmpty(rootNode))
   {
      var logicals = rootNode[0].getElementsByTagName('c:AttributeMetadata');
      var rootnodenew = rootNode[0];
      var logicals = rootNode[0].getElementsByTagName('c:PicklistAttributeMetadata');
      for (var x = 0; x < logicals.length; x++)
      {
         var attType = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(logicals[x].getElementsByTagName('c:AttributeType')[0]);
         var attLabel = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(logicals[x].getElementsByTagName('c:DisplayName')[0].getElementsByTagName('a:Label')[0]);
         var entity = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(logicals[x].getElementsByTagName('c:EntityLogicalName')[0]);
         var att = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(logicals[x].getElementsByTagName('c:LogicalName')[0]);
         var schema = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(logicals[x].getElementsByTagName('c:SchemaName')[0]);
         var options = logicals[x].getElementsByTagName('c:OptionMetadata');
         var attType = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(rootNode[0].getElementsByTagName('c:AttributeType')[0]);
         //var attLabel = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(rootNode[0].getElementsByTagName('c:DisplayName')[0].getElementsByTagName('a:Label')[0]);
         //var entity = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(rootNode[0].getElementsByTagName('c:EntityLogicalName')[0]);
         //var att = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(rootNode[0].getElementsByTagName('c:LogicalName')[0]);
         //var schema = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(rootNode[0].getElementsByTagName('c:SchemaName')[0]);
         //var options = rootNode[0].getElementsByTagName('c:OptionMetadata');

         var attOf = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(logicals[x].getElementsByTagName('c:AttributeOf')[0]);
         var display = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(logicals[x].getElementsByTagName('c:DisplayName')[0]);
         var link = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(logicals[x].getElementsByTagName('c:LinkedAttributeId')[0]);
         var targets = logicals[x].getElementsByTagName('c:Targets');
         //var attOf = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(rootNode[0].getElementsByTagName('c:AttributeOf')[0]);
         //var display = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(rootNode[0].getElementsByTagName('c:DisplayName')[0]);
         //var link = Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(rootNode[0].getElementsByTagName('c:LinkedAttributeId')[0]);
         //var targets = rootNode[0].getElementsByTagName('c:Targets');

         var retObj = { AttributeType: attType,
         ...
         if (targets != null && targets.length > 0)
         {
            ...
            if (targetEntities != null)
            {
               for (var i = 0; i < targetEntities.length; i++)
               {
                  ...
                  targetList.push({
                     Entity: Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(target)
                  });
               }
            }
         ...
         if (options != null)
         {
            ...
            for (var i = 0; i < options.length; i++)
            {
               ...
               optionList.push({
                  Label: Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(option.getElementsByTagName('a:Label')[0]),
                  Value: Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML(option.getElementsByTagName('c:Value')[0])
               });
            }
...
Tribridge.CRMSDK.METADATA.Tiles.SoapParseAttributeResponse = function (responseXML)
{
...
Tribridge.CRMSDK.METADATA.Tiles.SoapParseResponse = function (responseXML)
{
}
 ...
 * @return The string.
 */
Tribridge.CRMSDK.METADATA.Tiles.GetTextPropertyXML = function (node)
{
 ...
 * @required obj
 */
Tribridge.CRMSDK.METADATA.Tiles.IsNullOrEmpty = function (obj)
{
 ...
 *
 */
Tribridge.CRMSDK.METADATA.Tiles.GetServerUrl = function ()
{
